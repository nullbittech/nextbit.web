    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-dark">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        ...
        >
          ...
          <motion.h2
            className="text-4xl md:text-5xl font-bold text-white mb-4 font-cairo"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.p
            className="text-xl md:text-2xl text-gray-300 mb-12 font-cairo"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <div className="group p-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl hover:bg-white/10 hover:scale-105 transition-all duration-300">
              <div className="flex flex-col items-center gap-4">
                <div className="p-4 bg-primary/20 rounded-2xl group-hover:bg-primary/30 transition-colors">
                  <Smartphone className="w-12 h-12 text-primary" />
                </div>
                <h3 className="text-xl font-bold text-white font-cairo">تطبيق السائقين</h3>
                <p className="text-gray-400 text-sm font-cairo">سهولة في التنفيذ والتتبع</p>
              </div>
            </div>
            ...
            <div className="group p-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl hover:bg-white/10 hover:scale-105 transition-all duration-300">
              <div className="flex flex-col items-center gap-4">
                ...
                <h3 className="text-xl font-bold text-white font-cairo">تطبيق الموردين</h3>
                <p className="text-gray-400 text-sm font-cairo">إنشاء وتتبع بسيط</p>
              </div>
            </div>
            ...
            <div className="group p-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl hover:bg-white/10 hover:scale-105 transition-all duration-300">
              <div className="flex flex-col items-center gap-4">
                ...
                <h3 className="text-xl font-bold text-white font-cairo">لوحة الإدارة</h3>
                <p className="text-gray-400 text-sm font-cairo">تحكم كامل ومراقبة</p>
              </div>
            </div>
          </motion.div>
        </motion.div>
