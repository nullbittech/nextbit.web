    ...
    <section className="py-24 bg-dark-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-400 font-cairo">نحو مستقبل أفضل في عالم التوصيل</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="relative p-8 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl hover:border-primary/50 transition-all duration-500">
              <div className="flex items-center gap-4 mb-6">
                <div className="p-4 bg-primary/20 rounded-2xl">
                  <Target className="w-10 h-10 text-primary" />
                </div>
                <h3 className="text-3xl font-bold text-white font-cairo">رؤيتنا</h3>
              </div>
              <p className="text-lg text-gray-300 leading-relaxed font-cairo">
          ...
          >
            ...
            <div className="relative p-8 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl hover:border-secondary/50 transition-all duration-500">
              <div className="flex items-center gap-4 mb-6">
                <div className="p-4 bg-secondary/20 rounded-2xl">
                  <Lightbulb className="w-10 h-10 text-secondary" />
                </div>
                <h3 className="text-3xl font-bold text-white font-cairo">رسالتنا</h3>
              </div>
              <p className="text-lg text-gray-300 leading-relaxed font-cairo">
